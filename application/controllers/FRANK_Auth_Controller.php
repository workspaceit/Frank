<?php
require_once dirname(__FILE__)."/FRANK_BASE_Controller.php";
class FRANK_Auth_Controller extends FRANK_BASE_Controller{
    protected $resp;
    protected $u_id;
    protected $gender;
    protected $pageData;
    ...
    function __construct(){
        ...
        $this->resp = array();
        $this->sessionCheck();
        $this->loadCommonPropertiesOfUser();
    }
   ...
   private function loadCommonPropertiesOfUser(){
