                ...
                <?php if($i<4){ ?>
                        <div class="plus_container">
                             <div class="progressbar" style="margin: 7px 0 2px 10px;float:left;"><!--Blue-->
                                ...
                                <div class="i_bar_s" style="border-right:1px solid #111;width:0%;"><span class="inside-middle"></span></div>
                                <div class="top_inf"><span class="span_name"><?php  echo $sub_category; ?></span><span class="span_score"><span class="span_score"></span></span></div>
                            </div>
    ...
    function get_trait_question_answer(trait_category_id,dynamic_id,point,q_element){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                console.log("fake_point "+fake_traits_point);
                console.log("Real_point "+real_traits_point);
                console.log(resp.id);
            },
            error:function(){}
        });
                                ...
                                <span class="vi_span"><?php echo $temp_static_traits[0][1]; ?></span><br>
                                    <div class="block1">
                                        <?php  for($i=0;$i<$array_size;$i++){ ?> <!-- Only One Block is Dynamic rest is static -->
                                                   <?php  trait_box($i,$temp_static_traits[$i][0],$temp_static_traits[$i][2],$array_size,$encrypt_tbl_primary_key_obj); ?> 
                                        <?php }  ?>
