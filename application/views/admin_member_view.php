		...
		<div style="float:right;width:auto;margin:0 10px 0 0;">
			...
			<a style="color:#fff;" href="javascript:submit_delete_select()"><div class="btn_save_edit" style="margin: 10px 24px 10px 20px;">
               ...
               <div class="flag_desc">
                <p>Flags</p>
                  <div class="flag_spec">
                    <img src="<?php echo base_url(); ?>images/crossback.png" width="40" height="40">
                    <p>More than one account from one IP address.</p>
                  </div>
                  <div class="flag_spec">
                    <img src="<?php echo base_url(); ?>images/crossback.png" width="40" height="40">
                    <p>Signing in more than one location at same time</p>
                  </div>
                  <div class="flag_spec">
                    <img src="<?php echo base_url(); ?>images/crossback.png" width="40" height="40">
                    <p>Gossip scores for other people too negative</p>
                  </div>
                  <div class="flag_spec">
                    <img src="<?php echo base_url(); ?>images/crossblank.png" width="40" height="40">
                    <p>Highly disputed profile</p>
                  </div>
               </div>
                 <div id="user_mail">
