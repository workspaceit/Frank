...
<script type="text/javascript">
    ...
    function submit_update_data_of_user_profile_data(prefix, col1, col2) {
        ...
        $.ajax({
            type: "GET",
            url: "user_profile_data/update_any_col_get?" + col1 +
            "=" + col1_data +
            "&" + col2 +
            "=" + col2_data,
            success: function (data) {
                $('#' + prefix + '_value').fadeIn(1000, function () {
                    ...
                    if (col1_data != "" && col2_data != "") {
                        $('#' + prefix + '_value').html(col1_data + " &#38 " + col2_data);
                    } else if (col1_data != "") {
                        $('#' + prefix + '_value').html(col1_data);
                    } else if (col2_data != "") {
                        $('#' + prefix + '_value').html(col2_data);
                    }
                    show_all_edit_anchor();
...
<div class="profile_pic_div"><!--Profile Picture-->
    <?php foreach ($basic_info_all as $basic_data) { ?>
        <div class="pic_div">
            ...
            <img id="user_profile_picture" src="<?php echo base_url() . 'uploads/' . $basic_data->pic_path; ?>"
                 height="154" width="125"/>
        </div>
    <?php } ?>
    <div class="pp_progress">
        ...
        <div class="change_picture">
            ...
            <input type="file" id="change_profile_picture" name="change_profile_picture" class="change_file_browse"/>
        </div>
    </div>
</div>
        ...
        <div class="editBioDataDiv">
            ...
            <div id="get_location_value" style="float: left;">
                ...
                if ($profile_data->current_location_1 != "" && $profile_data->current_location_2 != "") {
                    echo $profile_data->current_location_1 . ' & ' . $profile_data->current_location_2;
                } elseif ($profile_data->current_location_1 != "") {
                    echo $profile_data->current_location_1;
                } elseif ($profile_data->current_location_2 != "") {
                    echo $profile_data->current_location_2;
                }
                ?>
        ...
        <div class="editBioDataDiv">
            ...
            <div id="get_home_town_value" style="float: left;">
                ...
                if ($profile_data->home_town_1 != "" && $profile_data->home_town_2 != "") {
                    echo $profile_data->home_town_1 . ' & ' . $profile_data->home_town_2;
                } elseif ($profile_data->home_town_1 != "") {
                    echo $profile_data->home_town_1;
                } elseif ($profile_data->home_town_2 != "") {
                    echo $profile_data->home_town_2;
                }
                ?>
    ...
    <div class="bi_input">
        ...
        <div class="editBioDataDiv">
            ...
            <div id="get_high_school_value" style="float: left;">
                <?php echo $profile_data->high_school; ?>
        ...
        <div class="editBioDataDiv">
            ...
            <div id="get_higher_education_value" style="float: left;">
                ...
                if ($profile_data->higher_education_1 != "" && $profile_data->higher_education_2 != "") {
                    echo $profile_data->higher_education_1 . ' & ' . $profile_data->higher_education_2;
            ...
            <a class="bio_data_edit_anchor" style="float:right;display:none;" id="get_higher_education_anchor"
        ...
        <div class="editBioDataDiv">
            ...
            <div id="get_workplace_value" style="float: left;">
                ...
                if ($profile_data->workplace_1 != "" && $profile_data->workplace_2 != "") {
                    echo $profile_data->workplace_1 . ' & ' . $profile_data->workplace_2;
                } elseif ($profile_data->workplace_1 != "") {
                    echo $profile_data->workplace_1;
                } elseif ($profile_data->workplace_2 != "") {
                    echo $profile_data->workplace_2;
                }
                ?>
        ...
        <div class="editBioDataDiv">
            ...
            <div id="get_organization_value" style="float: left;">
                ...
                if ($profile_data->organization_1 != "" && $profile_data->organization_2 != "") {
                    echo $profile_data->organization_1 . ' & ' . $profile_data->organization_2;
                } elseif ($profile_data->organization_1 != "") {
                    echo $profile_data->organization_1;
                } elseif ($profile_data->organization_2 != "") {
                    echo $profile_data->organization_2;
                }
                ?>
...
foreach ($user_about_all as $about_me_data) { ?>
    <div class="about_me">
        ...
        <div id="user_about_me_content"
             style="color:black;background:white;width:277px;height:190px;margin: 5px 5px 0px ; padding: 6px;border-radius: 5px 5px 5px 5px;"><?php echo $about_me_data->about_me; ?></div>
...
<div class="stats">
    ...
    <div class="progressbar" style="margin:10px 0;"><!--Blue-->
        <div class="bottom_bar"></div>
        <div class="i_bar" style="border-right:1px solid #111;background:#3973C2;"><span class="inside-middle"></span>
        </div>
    ...
    <div class="block1">
        ...
        <div class="progressbar" style="margin: 7px 0 2px 10px;"><!--Blue-->
            ...
            <div class="i_bar" style="border-right:1px solid #111;background:#3973C2;width:60%;"><span
                    class="inside-middle"></span></div>
            <div class="top_inf"><span class="span_name">Honest</span><span class="span_score"><span class="span_score">60</span></span>
            </div>
        </div>
        <div class="progressbar" style="margin: 7px 0 2px 10px;"><!--Blue-->
            <div class="bottom_bar"></div>
    ...
    <div class="block1">
        ...
        <div class="progressbar" style="margin: 7px 0 2px 10px;"><!--green-->
            ...
            <div class="i_bar" style="border-right:1px solid #111;background:#00A650;width:75%;"><span
                    class="inside-middle"></span></div>
            <div class="top_inf"><span class="span_name">Funny</span><span class="span_score"><span class="span_score">75</span></span>
            </div>
        </div>
        <div class="progressbar" style="margin: 7px 0 2px 10px;"><!--green-->
            <div class="bottom_bar"></div>
    ...
    <div class="block1">
        <div class="progressbar" style="margin: 7px 0 2px 10px;"><!--Yellow-->
            ...
            <div id="t" class="i_bar" style="border-right:1px solid #111;background:yellow;width:75%;"><span
                    class="inside-middle"></span></div>
            <div class="top_inf"><span class="span_name">Sports</span><span class="span_score"><span class="span_score">75</span></span>
            </div>
        </div>
        <div class="progressbar" style="margin: 7px 0 2px 10px;"><!--Yellow-->
            <div class="bottom_bar"></div>
            <div id="t" class="i_bar" style="border-right:1px solid #111;background:yellow;width:90%;"><span
                    class="inside-middle"></span></div>
            <div class="top_inf"><span class="span_name">Maths</span><span class="span_score"><span class="span_score">90</span></span>
            </div>
        </div>
        <div class="progressbar" style="margin: 7px 0 2px 10px;"><!--Yellow-->
            <div class="bottom_bar"></div>
                        ...
                        <div class="gossip_score">
                            ...
                            <div class="progressbar" style="margin:0 0 0 12px;"><!--violet-->
                                ...
                                <div class="top_inf"><span class="span_name">Rank</span><span class="span_score"><span
                                            class="span_score">1875</span></span></div>
                            </div>
                        </div>
                    </div>
